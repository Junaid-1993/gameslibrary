import { z } from "zod";
import { optionalChangePasswordFieldsSchema, optionalChangePasswordSchema } from "./password";
...
export const profileSchema = z
  .object({
    ...
    visibility: z.string(),
    ...optionalChangePasswordFieldsSchema.shape,
  })
  .and(optionalChangePasswordSchema);
