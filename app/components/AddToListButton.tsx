...
export default function AddToListButton({
  ...
  return (
    <Button
      ...
      className={cn(
        "dark:bg-surface-500 dark:border-border-400 relative h-auto cursor-pointer overflow-hidden border transition-all duration-300 ease-in-out dark:hover:bg-zinc-800",
        className
      )}
    >
      <motion.div
